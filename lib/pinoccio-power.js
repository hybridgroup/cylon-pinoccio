...
PinoccioPower.prototype.isCharging = function(callback) {
  ...
  this.adaptor.command('printf("%b", power.ischarging)', callback);
};

PinoccioPower.prototype.percent = function(callback) {
  callback = callback || function() {};
  this.adaptor.command('printf("%d", power.percent)', callback);
};

PinoccioPower.prototype.voltage = function(callback) {
  callback = callback || function() {};
  this.adaptor.command('printf("%d", power.voltage)', callback);
};

PinoccioPower.prototype.enableVcc = function() {
  this.adaptor.command("power.enable_vcc");
};

PinoccioPower.prototype.disableVcc = function() {
  this.adaptor.command("power.disable_vcc");
};

PinoccioPower.prototype.report = function(callback) {
  callback = callback || function() {};
  this.adaptor.command('printf("%s", power.report)', callback);
};
