...
describe("Pinoccio-LED", function() {
  ...
  describe("#rgb", function() {
    it("tells the connection to set the LED's rgb color", function() {
      led.rgb(255, 255, 255);
      expect(led.connection.command).to.be.calledWith('led.setrgb(255, 255, 255)');
    });
  });
  ...
  describe("#saveTorch", function() {
    it("tells the connection to save the LED torch", function() {
      ...
      expect(led.connection.command).to.be.calledWith('led.savetorch(255, 255, 255)');
    });
  });
  ...
  describe("#blink", function() {
    it("tells the connection to blink the LED", function() {
      ...
      expect(led.connection.command).to.be.calledWith('led.blink(255, 255, 255)');
    });
  });
});
